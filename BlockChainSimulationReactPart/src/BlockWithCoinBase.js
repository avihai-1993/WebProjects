...
import CoinBaseMarker from './CoinBaseMarker';


const BlockWithCoinBase = ({block}) => {
        ...
        <div>
            ...
            <div className="form-horizontal">
                ...
                <div className="form-group">
                    ...
                    <div className="col-sm-10">
                        {
                            <CoinBaseMarker coin={block.coinBase}></CoinBaseMarker>
                        }
...
export default BlockWithCoinBase;
